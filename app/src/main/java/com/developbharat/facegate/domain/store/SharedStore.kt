...
class SharedStore(private val sharedPreferences: SharedPreferences, private val gson: Gson) : ISharedStore {
    ...
    override fun <T> useValue(name: String, clazz: Class<T>): T {
        ...
        return gson.fromJson(value, clazz) ?: throw Exception("Failed to Serialize value in SharedStore for $name")
    }
